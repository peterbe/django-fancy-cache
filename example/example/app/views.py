...
def home(request):
    ...
    return render(request, "home.html", {"remembered_urls": remembered_urls})
...
def page1(request):
    ...
    t1 = time.time()
    print(t1 - t0)
    return render(request, "page.html", dict(result=commafy(result), page="1"))
...
def page2(request):
    ...
    t1 = time.time()
    print(t1 - t0)
    return render(request, "page.html", dict(result=commafy(result), page="2"))


def post_processor(response, request):
    response.content = response.content.replace(
        "</body>", "<footer>Kilroy was here!</footer></body>"
    )
    return response
...
def page3(request):
    ...
    t1 = time.time()
    print(t1 - t0)
    return render(request, "page.html", dict(result=commafy(result), page="3"))
...
def post_processor_always(response, request):
    ...
    response.content = response.content.replace(
        "</body>", "<footer>Right here right now %s</footer></body>" % now
    )
    return response
...
def page4(request):
    ...
    t1 = time.time()
    print(t1 - t0)
    return render(request, "page.html", dict(result=commafy(result), page="4"))
...
def page5(request):
    ...
    t1 = time.time()
    print(t1 - t0)
    return render(request, "page.html", dict(result=commafy(result), page="5"))
